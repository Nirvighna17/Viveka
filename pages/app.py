...
if menu == "Home":
    ...
    st.info("⚠️ Note: This app is for information only. Not a substitute for professional medical advice.")
    st.markdown("---")
    ...
    with col1:
        ...
        uploaded_file = st.file_uploader("Upload a clear photo of the ingredients label", type=["jpg", "jpeg", "png"])
    ...
    with col2:
        st.subheader("Type or Edit Ingredients")
