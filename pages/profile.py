# pages/profile.py — Viveka (FINAL FIXED)
...
if profile:
    ...
    # ---- Edit Option ----
    edit_mode = st.checkbox("✏️ Edit Profile", value=False)
    ...
    if edit_mode:
        with st.form("edit_form"):
            ...
            with col1:
                ...
                profile_pic_path = profile[9] if profile and profile[9] and os.path.exists(profile[9]) else str(DEFAULT_PIC)
                if uploaded_file:
